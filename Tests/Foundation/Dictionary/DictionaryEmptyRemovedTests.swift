...
final class DictionaryEmptyRemovedTests: XCTestCase {
    ...
    func testEmptyStringRemoved() {
        ...
        XCTAssertEqual(["hello": "world", "!": ""].emptyRemoved as! [String: String], ["hello": "world"])
        XCTAssertEqual(["hello": ["world", "!", ""]].emptyRemoved as! [String: [String]], ["hello": ["world", "!"]])
        XCTAssertEqual(["hello": ["world": "!", "": ""]].emptyRemoved as! [String: [String: String]], ["hello": ["world": "!"]])
        XCTAssertEqual(["hello": ["world": ["!", ""]]].emptyRemoved as! [String: [String: [String]]], ["hello": ["world": ["!"]]])
        XCTAssertEqual(["hello": ["world": "!", "!": NSNull()]].emptyRemoved as! [String: [String: String]], ["hello": ["world": "!"]])
        XCTAssertEqual(["hello": ["world": ["!", NSNull()]]].emptyRemoved as! [String: [String: [String]]], ["hello": ["world": ["!"]]])
    }
